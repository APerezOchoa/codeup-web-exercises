...
function analyzeColor(color) {
    if(color === "red"){
        ...
        return "I once saw a real life yellow submarine!";
    }else if(color === "green"){
        return "Green like grass.";
    }else if(color === "blue"){
        return "Blue like the pacific ocean.";
    }else if(color === "indigo"){
        return "Indigo is a color.";
    }else if(color === "violet"){
        return "Violet is a nice color.";
    }else{
...
switch(randomColor) {
    case "red":
        ...
        break;
    case "orange":
        alert ("You can't rhyme with orange...");
        break;
    case "yellow":
        alert ("I once saw a real life yellow submarine!");
        break;
    case "green":
        alert ("Green like grass.");
        break;
    case "blue":
        alert ("Blue like the pacific ocean.");
        break;
    case "indigo":
...
alert("Your lucky number is " + luckyNumber + ". Your total before " +
    "discount was $" + totalBill + ". Your discounted total is now $"
...
let userYn = confirm("Would you like to enter a number?");
if(userYn){
    ...
    if(!isNaN(userNumber)){
        ...
        alert("That is the incorrect input data type. Please use numbers only.");
    }
}else{
}